...
//           <div className="flex space-x-5 menu-btn">
//             <nav className="hidden lg:flex items-center space-x-14    bg-[#0D378D1F] rounded-4xl px-5.5 py-3.5 menubar">
//               <Link
//                 href="/"
...
//             <div className="hidden lg:flex items-center space-x-4 btn-img-nav">
//               <div className="flex items-center">
...
//                   </Link>
//                 </div>
//                 <Link href="tel:+1 587-466-6647"><span className="text-black font-medium">587-966-6547</span></Link>
//               </div>
//               <Link
//                 href="/contact"
      ...
      <header className="bg-white py-2 px-4 md:px-8 sticky top-0 z-[99999] shadow-lg">
        <div className=" mx-auto flex items-center justify-between">
          ...
          <div className="flex max-xl:absolute   justify-center left-0 right-0 m-auto max-xl:hidden">
            <nav className="hidden lg:flex lg:justify-between items-center space-x-14    bg-[#0D378D1F] rounded-4xl px-5.5 py-3.5 menubar" >
              <Link
                href="/"
                className={` ${currentPath == '/' ? 'text-[#0D378D]' : 'text-black' } hover:text-[#0D378D]  font-medium`}
              >
